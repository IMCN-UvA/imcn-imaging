...
public class FastMarchingTopologyCorrection {
	...
	public final void execute() {
		...
		try {
			...
			checkComposed=false;
			    ...
			    System.out.print("Specified LUT type not found: "+connectType+"\n");
				lut = null;
				ngb = 26;
				checkTopology=false;
			}
	...
	private final void fastMarchingObjectLevelsetIntialization() {
     ...
     private final void initializationFromMaximumIntensity() {
		if (debug) System.out.print("intialize from max intensity\n");		
     ...
     private final void initializationFromMinimumLevelset() {
         if (debug) System.out.print("intialize from min levelset\n");		
     ...
     private final void initializationFromImageBoundaries() {
 		if (debug) System.out.print("intialize from bounding box\n");		
    ...
    private final void fastMarchingTopologyPropagationLevelset() {
		...
		// compute the neighboring labels and corresponding distance functions (! not the MGDM functions !)
        if (debug) System.out.print("fast marching correction (levelsets)\n");	
    ...
    private final void fastMarchingTopologyPropagationIntensity() {
		...
		// compute the neighboring labels and corresponding distance functions (! not the MGDM functions !)
        if (debug) System.out.print("fast marching correction (intensity)\n");	

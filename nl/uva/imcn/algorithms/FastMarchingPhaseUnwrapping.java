...
public class FastMarchingPhaseUnwrapping {
	...
	public final void execute() {
		...
		if (debug) System.out.print("mean reliability: "+Rmean+"\n");		
        ...
        */
		...
		if (debug) System.out.print("number of seeds: "+nlb+"\n");	
		/*
        int seed = 0;
        for (int xyz=0;xyz<nxyz;xyz++) if (mask[xyz]) {
		...
		if (debug) System.out.print("number of labels: "+nlabels+"\n");		
		if (debug) System.out.print("number of merges: "+nmerge+"\n");	
